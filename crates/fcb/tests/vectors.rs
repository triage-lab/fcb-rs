...
use fcb::container::{encode_prefix, write_container, AeadParams, BundleKind, Header, KdfParams};
...
const FROZEN_CASE_HEX: &str = "";
const FROZEN_WORK_HEX: &str = "";
...
const FROZEN_SUBMISSION_HEX: &str = "";
...
/// Mirrors `bundle::pack_bytes`: the plaintext prefix is bound as the AEAD AAD
/// and `min_reader` is 2 (the AAD-authenticated format).
fn build(kind: BundleKind, meta: Value, payload: Vec<u8>) -> Vec<u8> {
    ...
    let prefix = encode_prefix(kind, &header).unwrap();
    let ct = compress::pack_payload(&key, &NONCE, &payload, &prefix).unwrap();
...
#[test]
fn prefix_tamper_matrix_is_rejected() {
    // The whole plaintext prefix (magic, KIND, container_version, hdr_len,
    // header) is bound as AAD. Tampering any of it makes the frozen case fail to
    // open — either as a structural error (bad magic / unknown KIND) or, when
    // the bytes still parse, as Corrupt because the AAD no longer matches.
    let base = hex::decode(FROZEN_CASE_HEX).unwrap();

    // (a) Flip a byte of a header field value (the case_id string): the header
    // still parses and the passphrase is right, but the AAD differs -> Corrupt.
    {
        let mut b = base.clone();
        let needle = b"acme-ir-2026-03";
        let pos = b
            .windows(needle.len())
            .position(|w| w == needle)
    ...
    // (b) Flip the container_version byte (offset 5): still parses, AAD breaks.
    {
        let mut b = base.clone();
        b[5] ^= 0x01;
        assert_eq!(
    ...
    // (c) Flip the KIND byte (offset 4) 1 -> 0: an unknown KIND, rejected
    // structurally before decryption.
    {
        let mut b = base.clone();
        b[4] ^= 0x01;
        assert!(matches!(
            bundle::open_bytes(&b, PASS),
            Err(fcb::FcbError::Malformed(_))
        ));
    }

    // (d) Flip a magic byte: BadMagic before any decryption.
    {
        let mut b = base.clone();
        b[1] ^= 0x01;
        assert_eq!(
            bundle::open_bytes(&b, PASS).unwrap_err(),
            fcb::FcbError::BadMagic
        );
    }
